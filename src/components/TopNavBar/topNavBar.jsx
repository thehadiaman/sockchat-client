...
export default function TopNavBar({user, notificationCount, setNotificationCount}) {
    return (
        <AppBar position="static" sx={{backgroundColor: 'rgba(var(--d87,255,255,255),1)', marginBottom: '20px'}}>
            <Container>
                <Toolbar>
                    ...
                    <TopNavBarMenu user={user} notificationCount={notificationCount} setNotificationCount={setNotificationCount}/>
                </Toolbar>
            </Container>
        </AppBar>
    );
